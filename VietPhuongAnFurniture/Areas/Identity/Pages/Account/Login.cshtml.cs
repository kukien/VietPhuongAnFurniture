...
namespace VietPhuongAnFurniture.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        private string LoginError = "Tài khoản hoặc mật khẩu không đúng";
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    _logger.LogWarning("Tài khoản người dũng đã bị khóa.");
        ...
        //        var roleresult = await _roleManager.CreateAsync(new IdentityRole(newRole.Name));
